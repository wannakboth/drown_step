...
class CyberTheme {
  ...
  static const Color neonPurple = Color(0xFF8E24AA);       // Darker purple for UI highlights
  static const Color textMain = Color(0xFFF1F5F9);         // Slate-50 high contrast text
  static const Color textMuted = Color(0xFF64748B);        // Slate-500 muted text
  static const Color borderTranslucent = Color(0x1F64748B); // Modern thin divider border color
  ...
  static TextStyle fontSubheading({double size = 16, Color color = textMain}) {
    return GoogleFonts.orbitron(
      fontSize: size,
  ...
  static TextStyle fontBody({double size = 14, Color color = textMain, bool bold = false}) {
